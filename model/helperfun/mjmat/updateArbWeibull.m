%
%updateArbWeibull  Updates structure which contains settings for and 
...
function RF = updateArbWeibull(RF, amplitude, response,threshPerformance)
...
% get updated posterioer using arbWeibull
