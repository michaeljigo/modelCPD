% Purpose:  Objective function for fit_thresholds_exp1_bootstrap.m

function [cost model] = fit_thresholds_objective_exp1_bootstrap(stimdrive,supdrive,attn,data,grating,energy,p,params)
